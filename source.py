...
# 
# Interesting Insights & Information: 
...
# 
# Potential Issues within my Data:
...
# 
# Duplicate Values and how I plan to deal with them: 
# I have played around with the data, I have noticed as well as in the Car Price Estimation dataset that it does contain dupelicate records for the same exact part and year. Similar to the missing values, I can remove them and still have a clear visual of the averages ensuring they are not skewed. 
# 
# Data Types Changed?
# Only a few columns contain prices in both the CarMD and the Car Prices Estimate datasets are stored with strings as "$" symbols. I will go ahead and convert them to numerical values so that I can conduct more accurate and reflective calculations and visualizations. 
# 
# 
# ## Data Visualization
...
car_parts = pd.read_csv("CPE.csv", encoding='latin-1')
...
data = pd.read_csv("CPE.csv", encoding='latin-1')
